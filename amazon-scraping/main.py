...
categorias = [biografias.categoria, ficcao_cientifica.categoria, romances.categoria, tecnologia.categoria, terror.categoria]
links = [biografias.url_livros, ficcao_cientifica.url_livros, romances.url_livros, tecnologia.url_livros, terror.url_livros]
